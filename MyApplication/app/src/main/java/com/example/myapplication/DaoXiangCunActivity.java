...
public class DaoXiangCunActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.daoxiangcun);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                TypedArray ta=getResources().obtainTypedArray(R.array.liwan_verdict);
                TypedArray tb=getResources().obtainTypedArray(R.array.liwan);
        ...
        tv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                TypedArray ta=getResources().obtainTypedArray(R.array.liwan);
