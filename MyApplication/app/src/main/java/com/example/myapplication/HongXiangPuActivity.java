...
public class HongXiangPuActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hongxiangpu);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                TypedArray ta=getResources().obtainTypedArray(R.array.shixiangyun_verdict);
                TypedArray tb=getResources().obtainTypedArray(R.array.shixiangyun);
        ...
        tv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                TypedArray ta=getResources().obtainTypedArray(R.array.shixiangyun);
