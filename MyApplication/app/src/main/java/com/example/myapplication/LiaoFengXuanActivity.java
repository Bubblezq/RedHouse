...
public class LiaoFengXuanActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.liaofengxuan);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                TypedArray ta=getResources().obtainTypedArray(R.array.jiaxichun_verdict);
                TypedArray tb=getResources().obtainTypedArray(R.array.jiaxichun);
        ...
        tv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                TypedArray ta=getResources().obtainTypedArray(R.array.jiaxichun);
