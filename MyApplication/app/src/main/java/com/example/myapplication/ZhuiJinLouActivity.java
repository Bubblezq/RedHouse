    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                TypedArray ta=getResources().obtainTypedArray(R.array.jiayingchun_verdict);
                TypedArray tb=getResources().obtainTypedArray(R.array.jiayingchun);
        ...
        tv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                TypedArray ta=getResources().obtainTypedArray(R.array.jiayingchun);
